...
# Stage 4 load hook: initialize shared state, core management, pulse timing, and chain objectives.
...
scoreboard players set #loaded slc.state 4
...
say [Soul Lightning Chain] Loaded stage 4 random chain skeleton.
