# Trigger one tuned pulse burst from the current core marker.
...
execute if score #chain_count slc.state < #max_chain_count slc.state run function soul_lightning:chain/summon_6_main
