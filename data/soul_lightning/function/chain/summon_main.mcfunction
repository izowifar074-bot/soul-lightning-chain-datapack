# Spawn one tuned main chain marker with an upward random direction.
...
summon minecraft:marker ~ ~0.15 ~ {Tags:["slc.chain","slc.main","slc.new_chain"]}
...
scoreboard players set @e[type=minecraft:marker,tag=slc.new_chain,sort=nearest,limit=1] slc.max_age 16
