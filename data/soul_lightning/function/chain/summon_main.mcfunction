# Spawn one main chain marker with a random direction.
...
scoreboard players set @e[type=minecraft:marker,tag=slc.new_chain,sort=nearest,limit=1] slc.max_age 10
